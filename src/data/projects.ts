...
export const projects: Project[] = [
  ...
  // ── AM Électricité ───────────────────────────────────────────────────────
  {
    ...
    sector: 'Électricité',
    sectorEn: 'Electrical',
    sectorColor: 'border-green-400/30 bg-green-400/10 text-green-400',
    type: 'Site vitrine',
    typeEn: 'Portfolio site',
    offer: 'Essentiel',
  ...
  // ── MM Sécurité ──────────────────────────────────────────────────────────
  {
    ...
    sector: 'Sécurité',
    sectorEn: 'Security',
    sectorColor: 'border-blue-400/30 bg-blue-400/10 text-blue-400',
  ...
  // ── Kor ──────────────────────────────────────────────────────────────────
  {
    ...
    sector: 'SaaS',
    sectorEn: 'SaaS',
    sectorColor: 'border-purple-400/30 bg-purple-400/10 text-purple-400',
    type: 'Landing page',
    typeEn: 'Landing page',
    offer: 'Essentiel',
